...
export default function App() {
  ...
  const stopajTitleText = useMemo(() => {
    // küçük bir özet satır (isteğe bağlı)
    return `≤180g: %${STOPAJ_TL_UP_TO_6M} • 181–365g: %${STOPAJ_TL_UP_TO_1Y} • 365g+: %${STOPAJ_TL_OVER_1Y}`;
  }, []);
  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: t.bg }]}>
      ...
      <SlidePanelModal
        ...
        subtitle="TL vadeli mevduat (bilgilendirme)"
        theme={t}
      >
        ...
        <Text style={[styles.micro, { color: t.muted, marginTop: 10 }]}>
          Stopaj oranları vade süresine göre değişebilir. Bu bilgiler bilgilendirme amaçlıdır; nihai oranlar için resmi kaynakları esas alın.
        </Text>
      </SlidePanelModal>
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
        ...
        >
          <View style={[styles.hero, { borderColor: t.border }]}>
            {/* glowlar: arka plan (HER ZAMAN ARKADA) */}
            <View
              pointerEvents="none"
              style={[
                styles.heroGlow,
            ...
            <View style={[styles.headerShield, { backgroundColor: t.bg }]}>
              ...
              {/* İstersen bu satırı istemiyorsan silebilirsin (kısa özet) */}
              {/* <Text style={[styles.micro, { color: t.muted, marginTop: 8 }]}>{stopajTitleText}</Text> */}
            </View>
...
const styles = StyleSheet.create({
  ...
  headerShield: { borderRadius: 18, paddingBottom: 10, position: "relative", zIndex: 2 },
